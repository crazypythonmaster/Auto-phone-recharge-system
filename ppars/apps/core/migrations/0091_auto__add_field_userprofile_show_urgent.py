...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'UserProfile.show_urgent'
        db.add_column(u'core_userprofile', 'show_urgent',
                      self.gf('django.db.models.fields.BooleanField')(default=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'UserProfile.show_urgent'
        db.delete_column(u'core_userprofile', 'show_urgent')
