...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Customer.email_success_charge'
        db.add_column(u'core_customer', 'email_success_charge',
                      self.gf('django.db.models.fields.BooleanField')(default=False),
                      keep_default=False)

        # Adding field 'Customer.email_success_refill'
        db.add_column(u'core_customer', 'email_success_refill',
                      self.gf('django.db.models.fields.BooleanField')(default=False),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Customer.email_success_charge'
        db.delete_column(u'core_customer', 'email_success_charge')

        # Deleting field 'Customer.email_success_refill'
        db.delete_column(u'core_customer', 'email_success_refill')
