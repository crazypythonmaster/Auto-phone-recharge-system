...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'Carrier.default_time'
        db.alter_column(u'core_carrier', 'default_time', self.gf('django.db.models.fields.CharField')(max_length=11))

    def backwards(self, orm):

        # Changing field 'Carrier.default_time'
        db.alter_column(u'core_carrier', 'default_time', self.gf('django.db.models.fields.CharField')(max_length=6))
