...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'Customer.primary_email'
        db.alter_column(u'core_customer', 'primary_email', self.gf('django.db.models.fields.EmailField')(default='', max_length=75))

    def backwards(self, orm):

        # Changing field 'Customer.primary_email'
        db.alter_column(u'core_customer', 'primary_email', self.gf('django.db.models.fields.EmailField')(max_length=75, null=True))
