...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.alter_column(u'core_phonenumber', 'number', self.gf('django.db.models.fields.CharField')(max_length=12))

    def backwards(self, orm):

        # Changing field 'PhoneNumber.number'
        db.alter_column(u'core_phonenumber', 'number', self.gf('django.db.models.fields.CharField')(max_length=10))
