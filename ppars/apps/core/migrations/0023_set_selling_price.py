...
class Migration(DataMigration):
    ...
    def forwards(self, orm):
        ...
        level = orm['price.SellingPriceLevel'].objects.get(level='1')
        for customer in orm.Customer.objects.filter(selling_price_level=None):
            customer.selling_price_level = level
            customer.save()
