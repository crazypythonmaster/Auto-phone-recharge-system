...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'CompanyProfile.verify_pin'
        db.add_column(u'core_companyprofile', 'verify_pin',
                      self.gf('django.db.models.fields.BooleanField')(default=False),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'CompanyProfile.verify_pin'
        db.delete_column(u'core_companyprofile', 'verify_pin')
