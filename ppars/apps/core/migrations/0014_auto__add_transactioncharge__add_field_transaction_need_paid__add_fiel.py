...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.create_table(u'core_transactioncharge', (
            (u'id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('charge', self.gf('ppars.apps.core.fields.BigForeignKey')(to=orm['core.CreditCardCharge'])),
        ...
        db.send_create_signal(u'core', ['TransactionCharge'])

        # Adding field 'Transaction.need_paid'
        db.add_column(u'core_transaction', 'need_paid',
                      self.gf('django.db.models.fields.DecimalField')(default='0', max_digits=5, decimal_places=2),
                      keep_default=False)

        # Adding field 'CreditCardCharge.customer'
        db.add_column(u'core_creditcardcharge', 'customer',
                      self.gf('ppars.apps.core.fields.BigForeignKey')(to=orm['core.Customer'], null=True),
                      keep_default=False)

        # Adding field 'CreditCardCharge.summ'
        db.add_column(u'core_creditcardcharge', 'summ',
                      self.gf('django.db.models.fields.DecimalField')(default='0', max_digits=5, decimal_places=2),
                      keep_default=False)


        # Changing field 'CreditCardCharge.tax'
        db.alter_column(u'core_creditcardcharge', 'tax', self.gf('django.db.models.fields.DecimalField')(default='0', max_digits=5, decimal_places=2))

        # Changing field 'CreditCardCharge.amount'
        db.alter_column(u'core_creditcardcharge', 'amount', self.gf('django.db.models.fields.DecimalField')(default='0', max_digits=5, decimal_places=2))

    def backwards(self, orm):
        # Deleting model 'TransactionCharge'
        db.delete_table(u'core_transactioncharge')

        # Deleting field 'Transaction.need_paid'
        db.delete_column(u'core_transaction', 'need_paid')

        # Deleting field 'CreditCardCharge.customer'
        db.delete_column(u'core_creditcardcharge', 'customer_id')

        # Deleting field 'CreditCardCharge.summ'
        db.delete_column(u'core_creditcardcharge', 'summ')


        # Changing field 'CreditCardCharge.tax'
        db.alter_column(u'core_creditcardcharge', 'tax', self.gf('django.db.models.fields.DecimalField')(null=True, max_digits=5, decimal_places=2))

        # Changing field 'CreditCardCharge.amount'
        db.alter_column(u'core_creditcardcharge', 'amount', self.gf('django.db.models.fields.DecimalField')(null=True, max_digits=5, decimal_places=2))
    ...
    models = {
        ...
        u'core.transactioncharge': {
            ...
            'charge': ('ppars.apps.core.fields.BigForeignKey', [], {'to': u"orm['core.CreditCardCharge']"}),
            'created': ('django.db.models.fields.DateTimeField', [], {'auto_now_add': 'True', 'blank': 'True'}),
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
