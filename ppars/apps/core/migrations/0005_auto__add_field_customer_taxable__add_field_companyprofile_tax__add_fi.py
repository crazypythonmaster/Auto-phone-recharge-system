...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Customer.taxable'
        db.add_column(u'core_customer', 'taxable',
                      self.gf('django.db.models.fields.BooleanField')(default=True),
                      keep_default=False)

        # Adding field 'CompanyProfile.tax'
        db.add_column(u'core_companyprofile', 'tax',
                      self.gf('django.db.models.fields.DecimalField')(default='0', max_digits=5, decimal_places=2),
                      keep_default=False)

        # Adding field 'CreditCardCharge.tax'
        db.add_column(u'core_creditcardcharge', 'tax',
                      self.gf('django.db.models.fields.DecimalField')(null=True, max_digits=5, decimal_places=2),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Customer.taxable'
        db.delete_column(u'core_customer', 'taxable')

        # Deleting field 'CompanyProfile.tax'
        db.delete_column(u'core_companyprofile', 'tax')

        # Deleting field 'CreditCardCharge.tax'
        db.delete_column(u'core_creditcardcharge', 'tax')
