...
class Migration(SchemaMigration):
    ...
    def backwards(self, orm):
        ...
        # Changing field 'Customer.user'
        db.alter_column(u'core_customer', 'user_id', self.gf('ppars.apps.core.fields.BigForeignKey')(to=orm['auth.User']))

        # User chose to not deal with backwards NULL issues for 'PlanDiscount.user'

        # The following code is provided here to aid in writing a correct migration
        # Changing field 'PlanDiscount.user'
        db.alter_column(u'core_plandiscount', 'user_id', self.gf('ppars.apps.core.fields.BigForeignKey')(to=orm['auth.User']))

        # User chose to not deal with backwards NULL issues for 'Transaction.user'

        # The following code is provided here to aid in writing a correct migration
        # Changing field 'Transaction.user'
        db.alter_column(u'core_transaction', 'user_id', self.gf('ppars.apps.core.fields.BigForeignKey')(to=orm['auth.User']))

        # Changing field 'Log.user'
        db.alter_column(u'core_log', 'user_id', self.gf('ppars.apps.core.fields.BigForeignKey')(to=orm['auth.User'], null=True))

        # User chose to not deal with backwards NULL issues for 'UnusedPin.user'

        # The following code is provided here to aid in writing a correct migration
        # Changing field 'UnusedPin.user'
        db.alter_column(u'core_unusedpin', 'user_id', self.gf('ppars.apps.core.fields.BigForeignKey')(to=orm['auth.User']))

        # User chose to not deal with backwards NULL issues for 'CarrierAdmin.user'

        # The following code is provided here to aid in writing a correct migration        # Adding field 'CarrierAdmin.user'
        db.add_column(u'core_carrieradmin', 'user',
                      self.gf('ppars.apps.core.fields.BigForeignKey')(to=orm['auth.User']),
                      keep_default=False)


        # Changing field 'CaptchaLogs.user'
        db.alter_column(u'core_captchalogs', 'user_id', self.gf('ppars.apps.core.fields.BigForeignKey')(to=orm['auth.User'], null=True))

        # User chose to not deal with backwards NULL issues for 'AutoRefill.user'

        # The following code is provided here to aid in writing a correct migration
        # Changing field 'AutoRefill.user'
        db.alter_column(u'core_autorefill', 'user_id', self.gf('ppars.apps.core.fields.BigForeignKey')(to=orm['auth.User']))
