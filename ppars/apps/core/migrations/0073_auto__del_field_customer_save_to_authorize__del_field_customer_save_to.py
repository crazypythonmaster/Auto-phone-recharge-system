...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Deleting field 'Customer.save_to_authorize'
        db.delete_column(u'core_customer', 'save_to_authorize')

        # Deleting field 'Customer.save_to_usaepay'
        db.delete_column(u'core_customer', 'save_to_usaepay')

        # Deleting field 'Customer.save_to_local'
        db.delete_column(u'core_customer', 'save_to_local')


    def backwards(self, orm):
        # Adding field 'Customer.save_to_authorize'
        db.add_column(u'core_customer', 'save_to_authorize',
                      self.gf('django.db.models.fields.BooleanField')(default=False),
                      keep_default=False)

        # Adding field 'Customer.save_to_usaepay'
        db.add_column(u'core_customer', 'save_to_usaepay',
                      self.gf('django.db.models.fields.BooleanField')(default=False),
                      keep_default=False)

        # Adding field 'Customer.save_to_local'
        db.add_column(u'core_customer', 'save_to_local',
                      self.gf('django.db.models.fields.BooleanField')(default=False),
                      keep_default=False)
