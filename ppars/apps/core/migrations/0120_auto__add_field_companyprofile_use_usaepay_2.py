...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'CompanyProfile.use_usaepay_2'
        db.add_column(u'core_companyprofile', 'use_usaepay_2',
                      self.gf('django.db.models.fields.BooleanField')(default=False),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'CompanyProfile.use_usaepay_2'
        db.delete_column(u'core_companyprofile', 'use_usaepay_2')
