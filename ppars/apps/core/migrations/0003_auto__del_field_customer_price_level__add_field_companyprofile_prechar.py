...
class Migration(SchemaMigration):
    ...
    depends_on = (
        ("price", "0002_set_selling_price"),
    )

    def forwards(self, orm):
        # Deleting field 'Customer.price_level'
        db.delete_column(u'core_customer', 'price_level')

        # Adding field 'CompanyProfile.precharge_failed_email'
        db.add_column(u'core_companyprofile', 'precharge_failed_email',
                      self.gf('django.db.models.fields.BooleanField')(default=True),
                      keep_default=False)

        # Deleting field 'Plan.third_selling_price'
        db.delete_column(u'core_plan', 'third_selling_price')

        # Deleting field 'Plan.first_selling_price'
        db.delete_column(u'core_plan', 'first_selling_price')

        # Deleting field 'Plan.second_selling_price'
        db.delete_column(u'core_plan', 'second_selling_price')


    def backwards(self, orm):
        # Adding field 'Customer.price_level'
        db.add_column(u'core_customer', 'price_level',
                      self.gf('django.db.models.fields.CharField')(default='1', max_length=1),
                      keep_default=False)

        # Deleting field 'CompanyProfile.precharge_failed_email'
        db.delete_column(u'core_companyprofile', 'precharge_failed_email')

        # Adding field 'Plan.third_selling_price'
        db.add_column(u'core_plan', 'third_selling_price',
                      self.gf('django.db.models.fields.DecimalField')(null=True, max_digits=5, decimal_places=2),
                      keep_default=False)

        # Adding field 'Plan.first_selling_price'
        db.add_column(u'core_plan', 'first_selling_price',
                      self.gf('django.db.models.fields.DecimalField')(null=True, max_digits=5, decimal_places=2),
                      keep_default=False)

        # Adding field 'Plan.second_selling_price'
        db.add_column(u'core_plan', 'second_selling_price',
                      self.gf('django.db.models.fields.DecimalField')(null=True, max_digits=5, decimal_places=2),
                      keep_default=False)
