...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Deleting field 'CreditCardCharge.transaction'
        db.delete_column(u'core_creditcardcharge', 'transaction_id')


    def backwards(self, orm):
        # Adding field 'CreditCardCharge.transaction'
        db.add_column(u'core_creditcardcharge', 'transaction',
                      self.gf('ppars.apps.core.fields.BigOneToOneField')(related_name='cc_charge', unique=True, null=True, to=orm['core.Transaction'], blank=True),
                      keep_default=False)
