...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.alter_column(u'core_transaction', 'pin', self.gf('django.db.models.fields.CharField')(default='', max_length=256))

    def backwards(self, orm):

        # Changing field 'Transaction.pin'
        db.alter_column(u'core_transaction', 'pin', self.gf('django.db.models.fields.CharField')(max_length=256, null=True))
