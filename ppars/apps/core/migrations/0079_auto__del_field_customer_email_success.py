...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Deleting field 'Customer.email_success'
        db.delete_column(u'core_customer', 'email_success')


    def backwards(self, orm):
        # Adding field 'Customer.email_success'
        db.add_column(u'core_customer', 'email_success',
