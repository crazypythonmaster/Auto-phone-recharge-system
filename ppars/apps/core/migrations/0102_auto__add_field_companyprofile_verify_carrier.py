...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'CompanyProfile.verify_carrier'
        db.add_column(u'core_companyprofile', 'verify_carrier',
                      self.gf('django.db.models.fields.BooleanField')(default=False),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'CompanyProfile.verify_carrier'
        db.delete_column(u'core_companyprofile', 'verify_carrier')
