...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Deleting field 'CompanyProfile.customer_limit'
        db.delete_column(u'core_companyprofile', 'customer_limit')

        # Adding field 'CompanyProfile.schedule_limit'
        db.add_column(u'core_companyprofile', 'schedule_limit',
                      self.gf('django.db.models.fields.IntegerField')(default=0, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Adding field 'CompanyProfile.customer_limit'
        db.add_column(u'core_companyprofile', 'customer_limit',
                      self.gf('django.db.models.fields.IntegerField')(default=0, null=True, blank=True),
                      keep_default=False)

        # Deleting field 'CompanyProfile.schedule_limit'
        db.delete_column(u'core_companyprofile', 'schedule_limit')
