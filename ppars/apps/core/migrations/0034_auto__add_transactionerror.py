...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding model 'TransactionError'
        db.create_table(u'core_transactionerror', (
        ...
        db.send_create_signal(u'core', ['TransactionError'])


    def backwards(self, orm):
        # Deleting model 'TransactionError'
        db.delete_table(u'core_transactionerror')
