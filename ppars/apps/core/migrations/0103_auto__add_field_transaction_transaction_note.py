...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Transaction.transaction_note'
        db.add_column(u'core_transaction', 'transaction_note',
                      self.gf('django.db.models.fields.TextField')(null=True, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Transaction.transaction_note'
        db.delete_column(u'core_transaction', 'transaction_note')
