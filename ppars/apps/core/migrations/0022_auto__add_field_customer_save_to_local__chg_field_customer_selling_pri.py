...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'Customer.selling_price_level'
        db.alter_column(u'core_customer', 'selling_price_level_id', self.gf('django.db.models.fields.related.ForeignKey')(default=1, to=orm['price.SellingPriceLevel']))
    ...
    def backwards(self, orm):
        ...
        # Changing field 'Customer.selling_price_level'
        db.alter_column(u'core_customer', 'selling_price_level_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['price.SellingPriceLevel'], null=True))
