...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'CompanyProfile.insufficient_funds_notification'
        db.add_column(u'core_companyprofile', 'insufficient_funds_notification',
                      self.gf('django.db.models.fields.BooleanField')(default=False),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'CompanyProfile.insufficient_funds_notification'
        db.delete_column(u'core_companyprofile', 'insufficient_funds_notification')
