...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'Customer.usaepay_custid'
        db.alter_column(u'core_customer', 'usaepay_custid', self.gf('django.db.models.fields.CharField')(max_length=100))

    def backwards(self, orm):

        # Changing field 'Customer.usaepay_custid'
        db.alter_column(u'core_customer', 'usaepay_custid', self.gf('django.db.models.fields.CharField')(max_length=30))
