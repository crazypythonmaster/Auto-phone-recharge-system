...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'Customer.zip'
        db.alter_column(u'core_customer', 'zip', self.gf('django.db.models.fields.CharField')(default='', max_length=10))
    ...
    def backwards(self, orm):
        ...
        db.create_table(u'core_creditcardcharge', (
            ...
            ('amount2', self.gf('django.db.models.fields.FloatField')()),
        ...
        # Changing field 'Customer.zip'
        db.alter_column(u'core_customer', 'zip', self.gf('django.db.models.fields.CharField')(max_length=5, null=True))
