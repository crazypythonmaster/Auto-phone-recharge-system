...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Carrier.default_time'
        db.add_column(u'core_carrier', 'default_time',
                      self.gf('django.db.models.fields.CharField')(default='', max_length=6, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Carrier.default_time'
        db.delete_column(u'core_carrier', 'default_time')
