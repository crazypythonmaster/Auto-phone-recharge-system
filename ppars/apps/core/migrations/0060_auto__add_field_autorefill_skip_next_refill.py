...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'AutoRefill.skip_next_refill'
        db.add_column(u'core_autorefill', 'skip_next_refill',
                      self.gf('django.db.models.fields.BooleanField')(default=False),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'AutoRefill.skip_next_refill'
        db.delete_column(u'core_autorefill', 'skip_next_refill')
    ...
    models = {
        ...
        u'core.autorefill': {
            ...
            'skip_next_refill': ('django.db.models.fields.BooleanField', [], {'default': 'False'}),
