...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'UserProfile.updates_email'
        db.alter_column(u'core_userprofile', 'updates_email', self.gf('django.db.models.fields.TextField')(null=True))

    def backwards(self, orm):

        # Changing field 'UserProfile.updates_email'
        db.alter_column(u'core_userprofile', 'updates_email', self.gf('django.db.models.fields.EmailField')(max_length=75, null=True))
