...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'WrongResultRedFin.contract_amount'
        db.add_column(u'core_wrongresultredfin', 'contract_amount',
                      self.gf('django.db.models.fields.CharField')(default='', max_length=10, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'WrongResultRedFin.contract_amount'
        db.delete_column(u'core_wrongresultredfin', 'contract_amount')
    ...
    models = {
        ...
        u'core.wrongresultredfin': {
            ...
            'customer': ('ppars.apps.core.fields.BigForeignKey', [], {'to': u"orm['core.Customer']", 'null': 'True'}),
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'phone_number': ('ppars.apps.core.fields.BigForeignKey', [], {'to': u"orm['core.PhoneNumber']", 'null': 'True'}),
