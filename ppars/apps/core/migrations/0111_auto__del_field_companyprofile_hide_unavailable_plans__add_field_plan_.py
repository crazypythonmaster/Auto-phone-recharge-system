...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Deleting field 'CompanyProfile.hide_unavailable_plans'
        db.delete_column(u'core_companyprofile', 'hide_unavailable_plans')

        # Adding field 'Plan.visible'
        db.add_column(u'core_plan', 'visible',
                      self.gf('django.db.models.fields.BooleanField')(default=True),
                      keep_default=False)


    def backwards(self, orm):
        # Adding field 'CompanyProfile.hide_unavailable_plans'
        db.add_column(u'core_companyprofile', 'hide_unavailable_plans',
                      self.gf('django.db.models.fields.BooleanField')(default=False),
                      keep_default=False)

        # Deleting field 'Plan.visible'
        db.delete_column(u'core_plan', 'visible')
