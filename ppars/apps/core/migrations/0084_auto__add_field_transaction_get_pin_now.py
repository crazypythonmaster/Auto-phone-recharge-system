...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Transaction.get_pin_now'
        db.add_column(u'core_transaction', 'get_pin_now',
                      self.gf('django.db.models.fields.BooleanField')(default=False),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Transaction.get_pin_now'
        db.delete_column(u'core_transaction', 'get_pin_now')
