...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'AutoRefill.pre_refill_sms_number'
        db.alter_column(u'core_autorefill', 'pre_refill_sms_number', self.gf('django.db.models.fields.CharField')(max_length=12, null=True))

    def backwards(self, orm):

        # Changing field 'AutoRefill.pre_refill_sms_number'
        db.alter_column(u'core_autorefill', 'pre_refill_sms_number', self.gf('django.db.models.fields.CharField')(max_length=10, null=True))
