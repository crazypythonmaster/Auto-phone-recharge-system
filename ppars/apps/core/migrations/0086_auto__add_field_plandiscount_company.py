...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'PlanDiscount.company'
        db.add_column(u'core_plandiscount', 'company',
                      self.gf('ppars.apps.core.fields.BigForeignKey')(to=orm['core.CompanyProfile'], null=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'PlanDiscount.company'
        db.delete_column(u'core_plandiscount', 'company_id')
