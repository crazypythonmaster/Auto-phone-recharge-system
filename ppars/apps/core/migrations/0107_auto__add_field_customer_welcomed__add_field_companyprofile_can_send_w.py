...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Customer.welcomed'
        db.add_column(u'core_customer', 'welcomed',
                      self.gf('django.db.models.fields.BooleanField')(default=False),
                      keep_default=False)

        # Adding field 'CompanyProfile.can_send_welcome_emails'
        db.add_column(u'core_companyprofile', 'can_send_welcome_emails',
                      self.gf('django.db.models.fields.BooleanField')(default=False),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Customer.welcomed'
        db.delete_column(u'core_customer', 'welcomed')

        # Deleting field 'CompanyProfile.can_send_welcome_emails'
        db.delete_column(u'core_companyprofile', 'can_send_welcome_emails')
