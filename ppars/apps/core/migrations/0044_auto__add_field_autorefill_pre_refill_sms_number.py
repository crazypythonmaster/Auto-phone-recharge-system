...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'AutoRefill.pre_refill_sms_number'
        db.add_column(u'core_autorefill', 'pre_refill_sms_number',
                      self.gf('django.db.models.fields.CharField')(max_length=10, null=True, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'AutoRefill.pre_refill_sms_number'
        db.delete_column(u'core_autorefill', 'pre_refill_sms_number')
