...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Customer.selling_price_level'
        db.add_column(u'core_customer', 'selling_price_level',
                      self.gf('django.db.models.fields.related.ForeignKey')(to=orm['price.SellingPriceLevel'], null=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Customer.selling_price_level'
        db.delete_column(u'core_customer', 'selling_price_level_id')
