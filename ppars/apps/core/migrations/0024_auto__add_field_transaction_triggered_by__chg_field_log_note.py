...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Transaction.triggered_by'
        db.add_column(u'core_transaction', 'triggered_by',
                      self.gf('django.db.models.fields.CharField')(default='System', max_length=32),
                      keep_default=False)


        # Changing field 'Log.note'
        db.alter_column(u'core_log', 'note', self.gf('django.db.models.fields.TextField')(null=True))

    def backwards(self, orm):
        # Deleting field 'Transaction.triggered_by'
        db.delete_column(u'core_transaction', 'triggered_by')


        # Changing field 'Log.note'
        db.alter_column(u'core_log', 'note', self.gf('django.db.models.fields.CharField')(max_length=256, null=True))
