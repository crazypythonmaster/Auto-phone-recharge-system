...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'CompanyProfile.deposit_amount_notification'
        db.add_column(u'core_companyprofile', 'deposit_amount_notification',
                      self.gf('django.db.models.fields.BooleanField')(default=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'CompanyProfile.deposit_amount_notification'
        db.delete_column(u'core_companyprofile', 'deposit_amount_notification')
