...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding model 'PinField'
        db.create_table(u'core_pinfield', (
            (u'id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('pin_report', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['core.PinReport'])),
            ('pin', self.gf('django.db.models.fields.CharField')(max_length=30)),
            ('plan', self.gf('django.db.models.fields.CharField')(max_length=100, blank=True)),
            ('cost', self.gf('django.db.models.fields.DecimalField')(null=True, max_digits=5, decimal_places=2)),
            ('used', self.gf('django.db.models.fields.BooleanField')(default=False)),
        ))
        db.send_create_signal(u'core', ['PinField'])

        # Adding field 'PinReport.subject'
        db.add_column(u'core_pinreport', 'subject',
                      self.gf('django.db.models.fields.CharField')(default='', max_length=100, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting model 'PinField'
        db.delete_table(u'core_pinfield')

        # Deleting field 'PinReport.subject'
        db.delete_column(u'core_pinreport', 'subject')
