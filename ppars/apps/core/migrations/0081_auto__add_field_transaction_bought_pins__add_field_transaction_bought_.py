...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Transaction.bought_pins'
        db.add_column(u'core_transaction', 'bought_pins',
                      self.gf('django.db.models.fields.PositiveSmallIntegerField')(default=0),
                      keep_default=False)

        # Adding field 'Transaction.bought_pins_retry_count'
        db.add_column(u'core_transaction', 'bought_pins_retry_count',
                      self.gf('django.db.models.fields.PositiveSmallIntegerField')(default=0),
                      keep_default=False)

        # Adding field 'Transaction.bought_pins_retry_count_err_token'
        db.add_column(u'core_transaction', 'bought_pins_retry_count_err_token',
                      self.gf('django.db.models.fields.PositiveSmallIntegerField')(default=0),
                      keep_default=False)

        # Adding field 'AutoRefill.need_buy_pins'
        db.add_column(u'core_autorefill', 'need_buy_pins',
                      self.gf('django.db.models.fields.BooleanField')(default=False),
                      keep_default=False)

        # Adding field 'AutoRefill.need_buy_pins_count'
        db.add_column(u'core_autorefill', 'need_buy_pins_count',
                      self.gf('django.db.models.fields.PositiveSmallIntegerField')(default=0),
                      keep_default=False)

        # Adding field 'AutoRefill.send_bought_pins'
        db.add_column(u'core_autorefill', 'send_bought_pins',
                      self.gf('django.db.models.fields.BooleanField')(default=False),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Transaction.bought_pins'
        db.delete_column(u'core_transaction', 'bought_pins')

        # Deleting field 'Transaction.bought_pins_retry_count'
        db.delete_column(u'core_transaction', 'bought_pins_retry_count')

        # Deleting field 'Transaction.bought_pins_retry_count_err_token'
        db.delete_column(u'core_transaction', 'bought_pins_retry_count_err_token')

        # Deleting field 'AutoRefill.need_buy_pins'
        db.delete_column(u'core_autorefill', 'need_buy_pins')

        # Deleting field 'AutoRefill.need_buy_pins_count'
        db.delete_column(u'core_autorefill', 'need_buy_pins_count')

        # Deleting field 'AutoRefill.send_bought_pins'
        db.delete_column(u'core_autorefill', 'send_bought_pins')
