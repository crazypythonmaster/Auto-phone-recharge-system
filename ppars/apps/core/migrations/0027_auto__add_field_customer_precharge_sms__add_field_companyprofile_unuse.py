...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Customer.precharge_sms'
        db.add_column(u'core_customer', 'precharge_sms',
                      self.gf('django.db.models.fields.BooleanField')(default=True),
                      keep_default=False)

        # Adding field 'CompanyProfile.unused_charge_notification'
        db.add_column(u'core_companyprofile', 'unused_charge_notification',
                      self.gf('django.db.models.fields.BooleanField')(default=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Customer.precharge_sms'
        db.delete_column(u'core_customer', 'precharge_sms')

        # Deleting field 'CompanyProfile.unused_charge_notification'
        db.delete_column(u'core_companyprofile', 'unused_charge_notification')
