...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Deleting field 'Transaction.eta_update'
        db.delete_column(u'core_transaction', 'eta_update')

        # Adding field 'Transaction.retry_interval'
        db.add_column(u'core_transaction', 'retry_interval',
                      self.gf('django.db.models.fields.PositiveIntegerField')(null=True),
                      keep_default=False)


    def backwards(self, orm):
        # Adding field 'Transaction.eta_update'
        db.add_column(u'core_transaction', 'eta_update',
                      self.gf('django.db.models.fields.DateTimeField')(null=True),
                      keep_default=False)

        # Deleting field 'Transaction.retry_interval'
        db.delete_column(u'core_transaction', 'retry_interval')
