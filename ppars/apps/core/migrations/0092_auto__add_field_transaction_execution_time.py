...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Transaction.execution_time'
        db.add_column(u'core_transaction', 'execution_time',
                      self.gf('django.db.models.fields.DateTimeField')(null=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Transaction.execution_time'
        db.delete_column(u'core_transaction', 'execution_time')
