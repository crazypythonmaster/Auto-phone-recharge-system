...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Deleting field 'PlanDiscount.discount'
        db.delete_column(u'core_plandiscount', 'discount')

        db.rename_column(u'core_plandiscount', 'discount1', 'discount')

        # Deleting field 'Transaction.cost'
        db.delete_column(u'core_transaction', 'cost')

        db.rename_column(u'core_transaction', 'cost1', 'cost')

        # Deleting field 'Transaction.profit'
        db.delete_column(u'core_transaction', 'profit')

        db.rename_column(u'core_transaction', 'profit1', 'profit')

        # Deleting field 'CreditCardCharge.amount'
        db.delete_column(u'core_creditcardcharge', 'amount')

        db.rename_column(u'core_creditcardcharge', 'amount1', 'amount')

        # Deleting field 'Plan.plan_cost'
        db.delete_column(u'core_plan', 'plan_cost')

        db.rename_column(u'core_plan', 'cost', 'plan_cost')

    def backwards(self, orm):

        db.rename_column(u'core_plandiscount', 'discount', 'discount1')

        # Adding field 'PlanDiscount.discount'
        db.add_column(u'core_plandiscount', 'discount',
                      self.gf('django.db.models.fields.FloatField')(default=0),
                      keep_default=False)

        db.rename_column(u'core_transaction', 'cost', 'cost1')

        # Adding field 'Transaction.cost'
        db.add_column(u'core_transaction', 'cost',
                      self.gf('django.db.models.fields.FloatField')(null=True),
                      keep_default=False)

        db.rename_column(u'core_transaction', 'profit', 'profit1')

        # Adding field 'Transaction.profit'
        db.add_column(u'core_transaction', 'profit',
                      self.gf('django.db.models.fields.FloatField')(null=True),
                      keep_default=False)

        db.rename_column(u'core_creditcardcharge', 'amount', 'amount1')

        # Adding field 'CreditCardCharge.amount'
        db.add_column(u'core_creditcardcharge', 'amount',
                      self.gf('django.db.models.fields.FloatField')(null=True),
                      keep_default=False)

        db.rename_column(u'core_plan', 'plan_cost', 'cost')

        # Adding field 'Plan.plan_cost'
        db.add_column(u'core_plan', 'plan_cost',
    ...
    models = {
        ...
        u'core.creditcardcharge': {
            ...
            'tax': ('django.db.models.fields.DecimalField', [], {'null': 'True', 'max_digits': '5', 'decimal_places': '2'}),
        ...
        u'core.transaction': {
            ...
            'profit': ('django.db.models.fields.DecimalField', [], {'null': 'True', 'max_digits': '5', 'decimal_places': '2'}),
