...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'UserProfile.updates_email'
        db.add_column(u'core_userprofile', 'updates_email',
                      self.gf('django.db.models.fields.EmailField')(max_length=75, null=True, blank=True),
                      keep_default=False)

        # Adding field 'CompanyProfile.show_updates'
        db.add_column(u'core_companyprofile', 'show_updates',
    ...
    def backwards(self, orm):
        ...
        # Deleting field 'UserProfile.updates_email'
        db.delete_column(u'core_userprofile', 'updates_email')

        # Deleting field 'CompanyProfile.show_updates'
        db.delete_column(u'core_companyprofile', 'show_updates')
    ...
    models = {
        ...
        u'core.autorefill': {
            ...
            'refill_type': ('django.db.models.fields.CharField', [], {'max_length': '2'}),
