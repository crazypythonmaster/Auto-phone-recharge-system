...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding model 'WrongResultRedFin'
        db.create_table(u'core_wrongresultredfin', (
            (u'id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('user_profile', self.gf('ppars.apps.core.fields.BigForeignKey')(to=orm['core.UserProfile'], null=True)),
            ('customer', self.gf('ppars.apps.core.fields.BigForeignKey')(to=orm['core.Customer'], null=True)),
            ('phone_number', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['core.PhoneNumber'], null=True)),
        ))
        db.send_create_signal(u'core', ['WrongResultRedFin'])


    def backwards(self, orm):
        # Deleting model 'WrongResultRedFin'
        db.delete_table(u'core_wrongresultredfin')
