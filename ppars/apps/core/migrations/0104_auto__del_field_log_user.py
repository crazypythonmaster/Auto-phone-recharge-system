...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.delete_column(u'core_log', 'user_id')


    def backwards(self, orm):
        # Adding field 'Log.user'
        db.add_column(u'core_log', 'user',
                      self.gf('ppars.apps.core.fields.BigForeignKey')(to=orm['auth.User'], null=True, on_delete=models.SET_NULL, blank=True),
                      keep_default=False)
