...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Deleting field 'CreditCardCharge.usaepay_transaction_id'
        db.delete_column(u'core_creditcardcharge', 'usaepay_transaction_id')

        # Adding field 'CreditCardCharge.payment_getaway'
        db.add_column(u'core_creditcardcharge', 'payment_getaway',
                      self.gf('django.db.models.fields.CharField')(default='A', max_length=1),
                      keep_default=False)


    def backwards(self, orm):
        # Adding field 'CreditCardCharge.usaepay_transaction_id'
        db.add_column(u'core_creditcardcharge', 'usaepay_transaction_id',
                      self.gf('django.db.models.fields.CharField')(max_length=200, null=True, blank=True),
                      keep_default=False)

        # Deleting field 'CreditCardCharge.payment_getaway'
        db.delete_column(u'core_creditcardcharge', 'payment_getaway')
