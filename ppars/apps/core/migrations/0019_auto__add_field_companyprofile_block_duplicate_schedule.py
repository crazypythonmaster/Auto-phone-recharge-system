...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'CompanyProfile.block_duplicate_schedule'
        db.add_column(u'core_companyprofile', 'block_duplicate_schedule',
                      self.gf('django.db.models.fields.BooleanField')(default=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'CompanyProfile.block_duplicate_schedule'
        db.delete_column(u'core_companyprofile', 'block_duplicate_schedule')
