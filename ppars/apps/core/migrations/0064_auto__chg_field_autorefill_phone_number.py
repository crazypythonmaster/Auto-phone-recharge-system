...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'AutoRefill.phone_number'
        db.alter_column(u'core_autorefill', 'phone_number', self.gf('django.db.models.fields.CharField')(max_length=12))

    def backwards(self, orm):

        # Changing field 'AutoRefill.phone_number'
        db.alter_column(u'core_autorefill', 'phone_number', self.gf('django.db.models.fields.CharField')(max_length=10))
