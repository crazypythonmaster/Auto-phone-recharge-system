...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'CompanyProfile.sales_agent_email'
        db.add_column(u'core_companyprofile', 'sales_agent_email',
                      self.gf('django.db.models.fields.EmailField')(default='', max_length=75, blank=True),
                      keep_default=False)

        # Adding field 'CompanyProfile.admin_email'
        db.add_column(u'core_companyprofile', 'admin_email',
                      self.gf('django.db.models.fields.EmailField')(default='', max_length=75, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'CompanyProfile.sales_agent_email'
        db.delete_column(u'core_companyprofile', 'sales_agent_email')

        # Deleting field 'CompanyProfile.admin_email'
        db.delete_column(u'core_companyprofile', 'admin_email')
