...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'Customer.charge_getaway'
        db.alter_column(u'core_customer', 'charge_getaway', self.gf('django.db.models.fields.CharField')(max_length=3))
        ...
        # Adding field 'CreditCardCharge.amount2'
        db.add_column(u'core_creditcardcharge', 'amount2',
    ...
    def backwards(self, orm):
        ...
        # Changing field 'Customer.charge_getaway'
        db.alter_column(u'core_customer', 'charge_getaway', self.gf('django.db.models.fields.CharField')(max_length=3, null=True))

        # Changing field 'Transaction.cost'
        db.alter_column(u'core_transaction', 'cost', self.gf('django.db.models.fields.DecimalField')(null=True, max_digits=5, decimal_places=2))

        # Changing field 'Transaction.profit'
        db.alter_column(u'core_transaction', 'profit', self.gf('django.db.models.fields.DecimalField')(null=True, max_digits=5, decimal_places=2))
        # Deleting field 'CreditCardCharge.amount2'
        db.delete_column(u'core_creditcardcharge', 'amount2')
    ...
    models = {
        ...
        u'core.transaction': {
            ...
            'profit': ('django.db.models.fields.FloatField', [], {'null': 'True', 'blank': 'True'}),
