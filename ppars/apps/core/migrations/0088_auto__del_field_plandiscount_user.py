...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Deleting field 'PlanDiscount.user'
        db.delete_column(u'core_plandiscount', 'user_id')


    def backwards(self, orm):
        # Adding field 'PlanDiscount.user'
        db.add_column(u'core_plandiscount', 'user',
                      self.gf('ppars.apps.core.fields.BigForeignKey')(to=orm['auth.User'], null=True, on_delete=models.SET_NULL),
                      keep_default=False)
