...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'CompanyProfile.tax'
        db.alter_column(u'core_companyprofile', 'tax', self.gf('django.db.models.fields.DecimalField')(max_digits=7, decimal_places=4))

    def backwards(self, orm):

        # Changing field 'CompanyProfile.tax'
        db.alter_column(u'core_companyprofile', 'tax', self.gf('django.db.models.fields.DecimalField')(max_digits=5, decimal_places=2))
