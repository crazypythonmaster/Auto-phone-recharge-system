...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'CompanyProfile.blank_usaepay_description'
        db.add_column(u'core_companyprofile', 'blank_usaepay_description',
                      self.gf('django.db.models.fields.BooleanField')(default=False),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'CompanyProfile.blank_usaepay_description'
        db.delete_column(u'core_companyprofile', 'blank_usaepay_description')
