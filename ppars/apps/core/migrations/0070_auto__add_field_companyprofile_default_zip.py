...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'CompanyProfile.default_zip'
        db.add_column(u'core_companyprofile', 'default_zip',
                      self.gf('django.db.models.fields.CharField')(default='', max_length=10, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'CompanyProfile.default_zip'
        db.delete_column(u'core_companyprofile', 'default_zip')
