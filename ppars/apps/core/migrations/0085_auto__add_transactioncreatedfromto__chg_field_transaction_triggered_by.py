...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding model 'TransactionCreatedFromTo'
        db.create_table(u'core_transactioncreatedfromto', (
            (u'id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('transaction_from', self.gf('ppars.apps.core.fields.BigForeignKey')(related_name='original_transaction', to=orm['core.Transaction'])),
            ('transaction_to', self.gf('ppars.apps.core.fields.BigForeignKey')(related_name='similar_transaction', to=orm['core.Transaction'])),
            ('created', self.gf('django.db.models.fields.DateTimeField')(auto_now_add=True, blank=True)),
        ))
        db.send_create_signal(u'core', ['TransactionCreatedFromTo'])


        # Changing field 'Transaction.triggered_by'
        db.alter_column(u'core_transaction', 'triggered_by', self.gf('django.db.models.fields.CharField')(max_length=128))

    def backwards(self, orm):
        # Deleting model 'TransactionCreatedFromTo'
        db.delete_table(u'core_transactioncreatedfromto')


        # Changing field 'Transaction.triggered_by'
        db.alter_column(u'core_transaction', 'triggered_by', self.gf('django.db.models.fields.CharField')(max_length=32))
