...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Customer.usaepay_customer_id_2'
        db.add_column(u'core_customer', 'usaepay_customer_id_2',
                      self.gf('django.db.models.fields.CharField')(default='', max_length=30, blank=True),
                      keep_default=False)

        # Adding field 'Customer.usaepay_custid_2'
        db.add_column(u'core_customer', 'usaepay_custid_2',
                      self.gf('django.db.models.fields.CharField')(default='', max_length=100, blank=True),
                      keep_default=False)

        # Adding field 'CompanyProfile.usaepay_source_key_2'
        db.add_column(u'core_companyprofile', 'usaepay_source_key_2',
                      self.gf('django.db.models.fields.CharField')(default='', max_length=100, blank=True),
                      keep_default=False)

        # Adding field 'CompanyProfile.usaepay_pin_2'
        db.add_column(u'core_companyprofile', 'usaepay_pin_2',
                      self.gf('django.db.models.fields.CharField')(default='', max_length=100, blank=True),
                      keep_default=False)

        # Adding field 'CompanyProfile.usaepay_username_2'
        db.add_column(u'core_companyprofile', 'usaepay_username_2',
                      self.gf('django.db.models.fields.CharField')(default='', max_length=100, blank=True),
                      keep_default=False)

        # Adding field 'CompanyProfile.usaepay_password_2'
        db.add_column(u'core_companyprofile', 'usaepay_password_2',
                      self.gf('django.db.models.fields.CharField')(default='', max_length=100, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Customer.usaepay_customer_id_2'
        db.delete_column(u'core_customer', 'usaepay_customer_id_2')

        # Deleting field 'Customer.usaepay_custid_2'
        db.delete_column(u'core_customer', 'usaepay_custid_2')

        # Deleting field 'CompanyProfile.usaepay_source_key_2'
        db.delete_column(u'core_companyprofile', 'usaepay_source_key_2')

        # Deleting field 'CompanyProfile.usaepay_pin_2'
        db.delete_column(u'core_companyprofile', 'usaepay_pin_2')

        # Deleting field 'CompanyProfile.usaepay_username_2'
        db.delete_column(u'core_companyprofile', 'usaepay_username_2')

        # Deleting field 'CompanyProfile.usaepay_password_2'
        db.delete_column(u'core_companyprofile', 'usaepay_password_2')
