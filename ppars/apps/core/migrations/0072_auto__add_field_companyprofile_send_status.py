...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'CompanyProfile.send_status'
        db.add_column(u'core_companyprofile', 'send_status',
                      self.gf('django.db.models.fields.CharField')(default='NO', max_length=2),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'CompanyProfile.send_status'
        db.delete_column(u'core_companyprofile', 'send_status')
