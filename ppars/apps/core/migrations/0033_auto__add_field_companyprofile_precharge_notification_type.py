...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'CompanyProfile.precharge_notification_type'
        db.add_column(u'core_companyprofile', 'precharge_notification_type',
                      self.gf('django.db.models.fields.CharField')(default='SM', max_length=2),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'CompanyProfile.precharge_notification_type'
        db.delete_column(u'core_companyprofile', 'precharge_notification_type')
