...
class Migration(DataMigration):
    ...
    def forwards(self, orm):
        ...
        for company in orm.CompanyProfile.objects.filter(send_prepayment_notification=False):
            company.send_prepayment_notification = True
            company.save()
    ...
    models = {
        ...
        u'core.companyprofile': {
            ...
            'send_prepayment_notification': ('django.db.models.fields.BooleanField', [], {'default': 'True'}),
