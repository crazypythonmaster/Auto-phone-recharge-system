...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Deleting field 'UserProfile.date_limit_license_expiries'
        db.delete_column(u'core_userprofile', 'date_limit_license_expiries')

        # Deleting field 'UserProfile.license_expiries'
        db.delete_column(u'core_userprofile', 'license_expiries')

        # Deleting field 'CompanyProfile.email_sales_agent'
        db.delete_column(u'core_companyprofile', 'email_sales_agent')

        # Adding field 'CompanyProfile.license_expiries'
        db.add_column(u'core_companyprofile', 'license_expiries',
                      self.gf('django.db.models.fields.BooleanField')(default=True),
                      keep_default=False)

        # Adding field 'CompanyProfile.date_limit_license_expiries'
        db.add_column(u'core_companyprofile', 'date_limit_license_expiries',
                      self.gf('django.db.models.fields.DateField')(null=True, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Adding field 'UserProfile.date_limit_license_expiries'
        db.add_column(u'core_userprofile', 'date_limit_license_expiries',
                      self.gf('django.db.models.fields.DateField')(null=True, blank=True),
                      keep_default=False)

        # Adding field 'UserProfile.license_expiries'
        db.add_column(u'core_userprofile', 'license_expiries',
                      self.gf('django.db.models.fields.BooleanField')(default=False),
                      keep_default=False)

        # Adding field 'CompanyProfile.email_sales_agent'
        db.add_column(u'core_companyprofile', 'email_sales_agent',
                      self.gf('django.db.models.fields.EmailField')(max_length=75, null=True, blank=True),
                      keep_default=False)

        # Deleting field 'CompanyProfile.license_expiries'
        db.delete_column(u'core_companyprofile', 'license_expiries')

        # Deleting field 'CompanyProfile.date_limit_license_expiries'
        db.delete_column(u'core_companyprofile', 'date_limit_license_expiries')
    ...
    models = {
        ...
        u'core.customer': {
            ...
            'email_success': ('django.db.models.fields.BooleanField', [], {'default': 'True'}),
            'enabled': ('django.db.models.fields.BooleanField', [], {'default': 'True'}),
