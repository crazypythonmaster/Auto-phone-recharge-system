...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Customer.send_pin_prerefill'
        db.add_column(u'core_customer', 'send_pin_prerefill',
                      self.gf('django.db.models.fields.CharField')(default='', max_length=2, blank=True),
                      keep_default=False)

        # Adding field 'CompanyProfile.send_pin_prerefill'
        db.add_column(u'core_companyprofile', 'send_pin_prerefill',
                      self.gf('django.db.models.fields.CharField')(default='NO', max_length=2, blank=True),
                      keep_default=False)

        # Adding field 'CompanyProfile.able_change_send_pin_prerefill'
        db.add_column(u'core_companyprofile', 'able_change_send_pin_prerefill',
                      self.gf('django.db.models.fields.BooleanField')(default=False),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Customer.send_pin_prerefill'
        db.delete_column(u'core_customer', 'send_pin_prerefill')

        # Deleting field 'CompanyProfile.send_pin_prerefill'
        db.delete_column(u'core_companyprofile', 'send_pin_prerefill')

        # Deleting field 'CompanyProfile.able_change_send_pin_prerefill'
        db.delete_column(u'core_companyprofile', 'able_change_send_pin_prerefill')
    ...
    models = {
        ...
        u'core.customer': {
            ...
            'send_pin_prerefill': ('django.db.models.fields.CharField', [], {'max_length': '2'}),
