...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'AutoRefill.pre_refill_sms'
        db.add_column(u'core_autorefill', 'pre_refill_sms',
                      self.gf('django.db.models.fields.BooleanField')(default=False),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'AutoRefill.pre_refill_sms'
        db.delete_column(u'core_autorefill', 'pre_refill_sms')
