...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'CompanyProfile.card_expiration_date_info'
        db.add_column(u'core_companyprofile', 'card_expiration_date_info',
                      self.gf('django.db.models.fields.BooleanField')(default=False),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'CompanyProfile.card_expiration_date_info'
        db.delete_column(u'core_companyprofile', 'card_expiration_date_info')
