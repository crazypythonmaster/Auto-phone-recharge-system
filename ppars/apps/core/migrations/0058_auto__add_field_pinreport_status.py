...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'PinReport.status'
        db.add_column(u'core_pinreport', 'status',
                      self.gf('django.db.models.fields.CharField')(default='S', max_length=3),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'PinReport.status'
        db.delete_column(u'core_pinreport', 'status')
