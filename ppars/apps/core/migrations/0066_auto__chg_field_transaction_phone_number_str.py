...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'Transaction.phone_number_str'
        db.alter_column(u'core_transaction', 'phone_number_str', self.gf('django.db.models.fields.CharField')(max_length=12, null=True))

    def backwards(self, orm):

        # Changing field 'Transaction.phone_number_str'
        db.alter_column(u'core_transaction', 'phone_number_str', self.gf('django.db.models.fields.CharField')(max_length=10, null=True))
