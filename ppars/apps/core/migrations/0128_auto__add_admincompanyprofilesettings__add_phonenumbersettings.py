...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding model 'AdminCompanyProfileSettings'
        db.create_table(u'core_admincompanyprofilesettings', (
            (u'id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('company', self.gf('ppars.apps.core.fields.BigForeignKey')(to=orm['core.CompanyProfile'])),
            ('bulk_promotion_twilio_number', self.gf('django.db.models.fields.CharField')(default='', max_length=10, blank=True)),
            ('bulk_promotion_twilio_sid', self.gf('django.db.models.fields.CharField')(default='', max_length=500, blank=True)),
            ('bulk_promotion_twilio_auth_token', self.gf('django.db.models.fields.CharField')(default='', max_length=500, blank=True)),
        ))
        db.send_create_signal(u'core', ['AdminCompanyProfileSettings'])

        # Adding model 'PhoneNumberSettings'
        db.create_table(u'core_phonenumbersettings', (
            (u'id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('phone_number', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['core.PhoneNumber'])),
            ('bulk_promotion_subscription', self.gf('django.db.models.fields.BooleanField')(default=True)),
        ))
        db.send_create_signal(u'core', ['PhoneNumberSettings'])


    def backwards(self, orm):
        # Deleting model 'AdminCompanyProfileSettings'
        db.delete_table(u'core_admincompanyprofilesettings')

        # Deleting model 'PhoneNumberSettings'
        db.delete_table(u'core_phonenumbersettings')
