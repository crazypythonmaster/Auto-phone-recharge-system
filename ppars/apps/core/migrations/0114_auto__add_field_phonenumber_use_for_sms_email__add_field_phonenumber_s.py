...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'PhoneNumber.use_for_sms_email'
        db.add_column(u'core_phonenumber', 'use_for_sms_email',
                      self.gf('django.db.models.fields.BooleanField')(default=False),
                      keep_default=False)

        # Adding field 'PhoneNumber.sms_gateway'
        db.add_column(u'core_phonenumber', 'sms_gateway',
                      self.gf('django.db.models.fields.related.ForeignKey')(default=1, to=orm['notification.SmsEmailGateway']),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'PhoneNumber.use_for_sms_email'
        db.delete_column(u'core_phonenumber', 'use_for_sms_email')

        # Deleting field 'PhoneNumber.sms_gateway'
        db.delete_column(u'core_phonenumber', 'sms_gateway_id')
