...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'Customer.sms_email'
        db.alter_column(u'core_customer', 'sms_email', self.gf('django.db.models.fields.CommaSeparatedIntegerField')(max_length=500))

    def backwards(self, orm):

        # Changing field 'Customer.sms_email'
        db.alter_column(u'core_customer', 'sms_email', self.gf('django.db.models.fields.CharField')(max_length=10))
