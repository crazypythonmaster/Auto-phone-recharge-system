...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'CreditCardCharge.refund_id'
        db.add_column(u'core_creditcardcharge', 'refund_id',
                      self.gf('django.db.models.fields.CharField')(default='', max_length=30, blank=True),
                      keep_default=False)

        # Adding field 'CreditCardCharge.refund_status'
        db.add_column(u'core_creditcardcharge', 'refund_status',
                      self.gf('django.db.models.fields.CharField')(default='', max_length=1, blank=True),
                      keep_default=False)

        # Adding field 'CreditCardCharge.refunded'
        db.add_column(u'core_creditcardcharge', 'refunded',
                      self.gf('django.db.models.fields.DateTimeField')(null=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'CreditCardCharge.refund_id'
        db.delete_column(u'core_creditcardcharge', 'refund_id')

        # Deleting field 'CreditCardCharge.refund_status'
        db.delete_column(u'core_creditcardcharge', 'refund_status')

        # Deleting field 'CreditCardCharge.refunded'
        db.delete_column(u'core_creditcardcharge', 'refunded')
