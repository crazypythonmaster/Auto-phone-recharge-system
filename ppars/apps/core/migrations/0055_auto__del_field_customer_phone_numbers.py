...
class Migration(SchemaMigration):
    ...
    depends_on = (
        ("core", "0052_auto__del_field_customer_phone_numbers"),
        ("core", "0053_auto__add_phonenumber__add_field_customer_phone_numbers"),
        ("core", "0054_set_phone_numbers"),
    )

    def forwards(self, orm):
        # Deleting field 'Customer.phone_numbers'
        db.delete_column(u'core_customer', 'phone_numbers')


    def backwards(self, orm):
        # Adding field 'Customer.phone_numbers'
        db.add_column(u'core_customer', 'phone_numbers',
                      self.gf('django.db.models.fields.CommaSeparatedIntegerField')(max_length=500, null=True),
                      keep_default=False)
