...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'AutoRefill.schedule'
        db.alter_column(u'core_autorefill', 'schedule', self.gf('django.db.models.fields.CharField')(max_length=11, null=True))

    def backwards(self, orm):

        # Changing field 'AutoRefill.schedule'
        db.alter_column(u'core_autorefill', 'schedule', self.gf('django.db.models.fields.CharField')(max_length=6, null=True))
