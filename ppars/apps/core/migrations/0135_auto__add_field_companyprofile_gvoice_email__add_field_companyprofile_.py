...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'CompanyProfile.gvoice_email'
        db.add_column(u'core_companyprofile', 'gvoice_email',
                      self.gf('django.db.models.fields.EmailField')(max_length=75, null=True, blank=True),
                      keep_default=False)

        # Adding field 'CompanyProfile.gvoice_pass'
        db.add_column(u'core_companyprofile', 'gvoice_pass',
                      self.gf('django.db.models.fields.CharField')(max_length=500, null=True, blank=True),
                      keep_default=False)

        # Adding field 'CompanyProfile.gvoice_enabled'
        db.add_column(u'core_companyprofile', 'gvoice_enabled',
                      self.gf('django.db.models.fields.BooleanField')(default=False),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'CompanyProfile.gvoice_email'
        db.delete_column(u'core_companyprofile', 'gvoice_email')

        # Deleting field 'CompanyProfile.gvoice_pass'
        db.delete_column(u'core_companyprofile', 'gvoice_pass')

        # Deleting field 'CompanyProfile.gvoice_enabled'
        db.delete_column(u'core_companyprofile', 'gvoice_enabled')
    ...
    models = {
        ...
        u'core.admincompanyprofilesettings': {
            'Meta': {'object_name': 'AdminCompanyProfileSettings'},
            'bulk_promotion_twilio_auth_token': ('django.db.models.fields.CharField', [], {'default': "''", 'max_length': '500', 'blank': 'True'}),
            'bulk_promotion_twilio_number': ('django.db.models.fields.CharField', [], {'default': "''", 'max_length': '10', 'blank': 'True'}),
            'bulk_promotion_twilio_sid': ('django.db.models.fields.CharField', [], {'default': "''", 'max_length': '500', 'blank': 'True'}),
        ...
        u'core.companyprofile': {
            ...
            'default_cash_prepayment_for_walk_in': ('django.db.models.fields.BooleanField', [], {'default': 'False'}),
            ...
            'gvoice_email': ('django.db.models.fields.EmailField', [], {'max_length': '75', 'null': 'True', 'blank': 'True'}),
            'gvoice_enabled': ('django.db.models.fields.BooleanField', [], {'default': 'False'}),
            'gvoice_pass': ('django.db.models.fields.CharField', [], {'max_length': '500', 'null': 'True', 'blank': 'True'}),
            'id': ('ppars.apps.core.fields.BigAutoField', [], {'primary_key': 'True'}),
            ...
            'send_prepayment_notification': ('django.db.models.fields.BooleanField', [], {'default': 'False'}),
            ...
            'usaepay_password_2': ('django.db.models.fields.CharField', [], {'max_length': '100', 'blank': 'True'}),
            'usaepay_pin': ('django.db.models.fields.CharField', [], {'max_length': '100', 'null': 'True', 'blank': 'True'}),
            'usaepay_pin_2': ('django.db.models.fields.CharField', [], {'max_length': '100', 'blank': 'True'}),
            'usaepay_source_key': ('django.db.models.fields.CharField', [], {'max_length': '100', 'null': 'True', 'blank': 'True'}),
            'usaepay_source_key_2': ('django.db.models.fields.CharField', [], {'max_length': '100', 'blank': 'True'}),
            'usaepay_username': ('django.db.models.fields.CharField', [], {'max_length': '100', 'null': 'True', 'blank': 'True'}),
            'usaepay_username_2': ('django.db.models.fields.CharField', [], {'max_length': '100', 'blank': 'True'}),
            ...
            'use_usaepay_2': ('django.db.models.fields.BooleanField', [], {'default': 'False'}),
        ...
        u'core.customer': {
            ...
            'usaepay_custid_2': ('django.db.models.fields.CharField', [], {'max_length': '100', 'blank': 'True'}),
            'usaepay_customer_id': ('django.db.models.fields.CharField', [], {'max_length': '30', 'null': 'True', 'blank': 'True'}),
            'usaepay_customer_id_2': ('django.db.models.fields.CharField', [], {'max_length': '30', 'blank': 'True'}),
            'user': ('ppars.apps.core.fields.BigForeignKey', [], {'to': u"orm['auth.User']", 'null': 'True', 'on_delete': 'models.SET_NULL'}),
        ...
        u'core.phonenumber': {
            ...
            'use_for_sms_email': ('django.db.models.fields.BooleanField', [], {'default': 'False'})
        },
        u'core.phonenumbersettings': {
            'Meta': {'object_name': 'PhoneNumberSettings'},
            'bulk_promotion_subscription': ('django.db.models.fields.BooleanField', [], {'default': 'True'}),
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'phone_number': ('django.db.models.fields.related.ForeignKey', [], {'to': u"orm['core.PhoneNumber']"})
        },
        u'core.pinfield': {
        ...
        u'core.transaction': {
            ...
            'company': ('ppars.apps.core.fields.BigForeignKey', [], {'to': u"orm['core.CompanyProfile']", 'null': 'True', 'blank': 'True'}),
            'completed': ('django.db.models.fields.CharField', [], {'default': "'NA'", 'max_length': '3', 'blank': 'True'}),
            ...
            'user': ('ppars.apps.core.fields.BigForeignKey', [], {'to': u"orm['auth.User']", 'null': 'True', 'on_delete': 'models.SET_NULL'}),
            'was_retried_on_step': ('django.db.models.fields.BooleanField', [], {'default': 'False'})
        },
        ...
        u'core.wrongresultredfin': {
            'Meta': {'object_name': 'WrongResultRedFin'},
            'contract_amount': ('django.db.models.fields.CharField', [], {'max_length': '10', 'blank': 'True'}),
            'customer': ('ppars.apps.core.fields.BigForeignKey', [], {'to': u"orm['core.Customer']", 'null': 'True'}),
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'phone_number': ('django.db.models.fields.related.ForeignKey', [], {'to': u"orm['core.PhoneNumber']", 'null': 'True'}),
            'user_profile': ('ppars.apps.core.fields.BigForeignKey', [], {'to': u"orm['core.UserProfile']", 'null': 'True'})
        },
