...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'CompanyProfile.can_swipe_card_in_customer'
        db.add_column(u'core_companyprofile', 'can_swipe_card_in_customer',
                      self.gf('django.db.models.fields.BooleanField')(default=False),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'CompanyProfile.can_swipe_card_in_customer'
        db.delete_column(u'core_companyprofile', 'can_swipe_card_in_customer')
