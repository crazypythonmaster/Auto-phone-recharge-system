...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'PlanDiscount.discount1'
        db.add_column(u'core_plandiscount', 'discount1',
                      self.gf('django.db.models.fields.DecimalField')(null=True, max_digits=5, decimal_places=2),
                      keep_default=False)

        # Adding field 'Transaction.cost1'
        db.add_column(u'core_transaction', 'cost1',
                      self.gf('django.db.models.fields.DecimalField')(null=True, max_digits=5, decimal_places=2),
                      keep_default=False)

        # Adding field 'Transaction.profit1'
        db.add_column(u'core_transaction', 'profit1',
                      self.gf('django.db.models.fields.DecimalField')(null=True, max_digits=5, decimal_places=2),
                      keep_default=False)

        # Adding field 'CreditCardCharge.amount1'
        db.add_column(u'core_creditcardcharge', 'amount1',
                      self.gf('django.db.models.fields.DecimalField')(null=True, max_digits=5, decimal_places=2),
                      keep_default=False)

        # Adding field 'Plan.cost'
        db.add_column(u'core_plan', 'cost',
                      self.gf('django.db.models.fields.DecimalField')(null=True, max_digits=5, decimal_places=2),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'PlanDiscount.discount1'
        db.delete_column(u'core_plandiscount', 'discount1')

        # Deleting field 'Transaction.cost1'
        db.delete_column(u'core_transaction', 'cost1')

        # Deleting field 'Transaction.profit1'
        db.delete_column(u'core_transaction', 'profit1')

        # Deleting field 'CreditCardCharge.amount1'
        db.delete_column(u'core_creditcardcharge', 'amount1')

        # Deleting field 'Plan.cost'
        db.delete_column(u'core_plan', 'cost')
    ...
    models = {
        ...
        u'core.creditcardcharge': {
            ...
            'amount1': ('django.db.models.fields.DecimalField', [], {'null': 'True', 'max_digits': '5', 'decimal_places': '2'}),
        ...
        u'core.transaction': {
            ...
            'cost1': ('django.db.models.fields.DecimalField', [], {'null': 'True', 'max_digits': '5', 'decimal_places': '2'}),
            ...
            'profit1': ('django.db.models.fields.DecimalField', [], {'null': 'True', 'max_digits': '5', 'decimal_places': '2'}),
