...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Customer.redfin_customer_key'
        db.add_column(u'core_customer', 'redfin_customer_key',
                      self.gf('django.db.models.fields.CharField')(default='', max_length=100, blank=True),
                      keep_default=False)

        # Adding field 'Customer.redfin_cc_info_key'
        db.add_column(u'core_customer', 'redfin_cc_info_key',
                      self.gf('django.db.models.fields.CharField')(default='', max_length=100, blank=True),
                      keep_default=False)

        # Adding field 'CompanyProfile.use_redfin'
        db.add_column(u'core_companyprofile', 'use_redfin',
                      self.gf('django.db.models.fields.BooleanField')(default=False),
                      keep_default=False)

        # Adding field 'CompanyProfile.redfin_username'
        db.add_column(u'core_companyprofile', 'redfin_username',
                      self.gf('django.db.models.fields.CharField')(default='', max_length=100, blank=True),
                      keep_default=False)

        # Adding field 'CompanyProfile.redfin_password'
        db.add_column(u'core_companyprofile', 'redfin_password',
                      self.gf('django.db.models.fields.CharField')(default='', max_length=100, blank=True),
                      keep_default=False)

        # Adding field 'CompanyProfile.redfin_vendor'
        db.add_column(u'core_companyprofile', 'redfin_vendor',
                      self.gf('django.db.models.fields.CharField')(default='', max_length=100, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Customer.redfin_customer_key'
        db.delete_column(u'core_customer', 'redfin_customer_key')

        # Deleting field 'Customer.redfin_cc_info_key'
        db.delete_column(u'core_customer', 'redfin_cc_info_key')

        # Deleting field 'CompanyProfile.use_redfin'
        db.delete_column(u'core_companyprofile', 'use_redfin')

        # Deleting field 'CompanyProfile.redfin_username'
        db.delete_column(u'core_companyprofile', 'redfin_username')

        # Deleting field 'CompanyProfile.redfin_password'
        db.delete_column(u'core_companyprofile', 'redfin_password')

        # Deleting field 'CompanyProfile.redfin_vendor'
        db.delete_column(u'core_companyprofile', 'redfin_vendor')
