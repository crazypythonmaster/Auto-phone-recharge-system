...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Transaction.customer_confirmation'
        db.add_column(u'core_transaction', 'customer_confirmation',
                      self.gf('django.db.models.fields.BooleanField')(default=False),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Transaction.customer_confirmation'
        db.delete_column(u'core_transaction', 'customer_confirmation')
