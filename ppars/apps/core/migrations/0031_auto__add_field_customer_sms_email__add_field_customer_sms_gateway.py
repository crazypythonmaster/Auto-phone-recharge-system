...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Customer.sms_email'
        db.add_column(u'core_customer', 'sms_email',
                      self.gf('django.db.models.fields.CharField')(default='', max_length=10, blank=True),
                      keep_default=False)

        # Adding field 'Customer.sms_gateway'
        db.add_column(u'core_customer', 'sms_gateway',
                      self.gf('django.db.models.fields.related.ForeignKey')(default=1, to=orm['notification.SmsEmailGateway']),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Customer.sms_email'
        db.delete_column(u'core_customer', 'sms_email')

        # Deleting field 'Customer.sms_gateway'
        db.delete_column(u'core_customer', 'sms_gateway_id')
