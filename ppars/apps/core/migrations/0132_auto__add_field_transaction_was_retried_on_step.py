...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Transaction.was_retried_on_step'
        db.add_column(u'core_transaction', 'was_retried_on_step',
                      self.gf('django.db.models.fields.BooleanField')(default=False),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Transaction.was_retried_on_step'
        db.delete_column(u'core_transaction', 'was_retried_on_step')
