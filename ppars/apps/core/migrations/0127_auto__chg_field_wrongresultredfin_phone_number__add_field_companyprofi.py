...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'WrongResultRedFin.phone_number'
        db.alter_column(u'core_wrongresultredfin', 'phone_number_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['core.PhoneNumber'], null=True))
        # Adding field 'CompanyProfile.send_prepayment_notification'
        db.add_column(u'core_companyprofile', 'send_prepayment_notification',
    ...
    def backwards(self, orm):
        ...
        # Changing field 'WrongResultRedFin.phone_number'
        db.alter_column(u'core_wrongresultredfin', 'phone_number_id', self.gf('ppars.apps.core.fields.BigForeignKey')(to=orm['core.PhoneNumber'], null=True))
        # Deleting field 'CompanyProfile.send_prepayment_notification'
        db.delete_column(u'core_companyprofile', 'send_prepayment_notification')
