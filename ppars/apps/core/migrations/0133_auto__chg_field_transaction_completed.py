...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'Transaction.completed'
        db.alter_column(u'core_transaction', 'completed', self.gf('django.db.models.fields.CharField')(max_length=3))

    def backwards(self, orm):

        # Changing field 'Transaction.completed'
        db.alter_column(u'core_transaction', 'completed', self.gf('django.db.models.fields.BooleanField')())
