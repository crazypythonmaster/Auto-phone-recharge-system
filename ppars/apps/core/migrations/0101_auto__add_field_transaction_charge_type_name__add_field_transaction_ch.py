...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Transaction.charge_type_name'
        db.add_column(u'core_transaction', 'charge_type_name',
                      self.gf('django.db.models.fields.CharField')(default='', max_length=50, blank=True),
                      keep_default=False)

        # Adding field 'Transaction.charge_getaway_name'
        db.add_column(u'core_transaction', 'charge_getaway_name',
                      self.gf('django.db.models.fields.CharField')(default='', max_length=50, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Transaction.charge_type_name'
        db.delete_column(u'core_transaction', 'charge_type_name')

        # Deleting field 'Transaction.charge_getaway_name'
        db.delete_column(u'core_transaction', 'charge_getaway_name')
