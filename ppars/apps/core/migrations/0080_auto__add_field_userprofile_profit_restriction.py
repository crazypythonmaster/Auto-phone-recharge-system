...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'UserProfile.profit_restriction'
        db.add_column(u'core_userprofile', 'profit_restriction',
                      self.gf('django.db.models.fields.BooleanField')(default=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'UserProfile.profit_restriction'
        db.delete_column(u'core_userprofile', 'profit_restriction')
