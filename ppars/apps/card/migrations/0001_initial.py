...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.create_table(u'card_card', (
            ...
            ('customer', self.gf('ppars.apps.core.fields.BigForeignKey')(related_name='cards', to=orm['core.Customer'])),
            ('number', self.gf('encrypted_fields.fields.EncryptedCharField')(max_length=255)),
            ('last4_number', self.gf('django.db.models.fields.IntegerField')(blank=True)),
            ('expiration_year', self.gf('encrypted_fields.fields.EncryptedIntegerField')(max_length=255)),
            ('expiration_month', self.gf('encrypted_fields.fields.EncryptedIntegerField')(max_length=255)),
            ('cvv', self.gf('encrypted_fields.fields.EncryptedCharField')(max_length=255)),
    ...
    models = {
        ...
        u'card.card': {
            'Meta': {'ordering': "('number',)", 'object_name': 'Card'},
            'created': ('django.db.models.fields.DateTimeField', [], {'auto_now_add': 'True', 'blank': 'True'}),
            'customer': ('ppars.apps.core.fields.BigForeignKey', [], {'related_name': "'cards'", 'to': u"orm['core.Customer']"}),
            'cvv': ('encrypted_fields.fields.EncryptedCharField', [], {'max_length': '255'}),
            'expiration_month': ('encrypted_fields.fields.EncryptedIntegerField', [], {'max_length': '255'}),
            'expiration_year': ('encrypted_fields.fields.EncryptedIntegerField', [], {'max_length': '255'}),
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'last4_number': ('django.db.models.fields.IntegerField', [], {'blank': 'True'}),
            'number': ('encrypted_fields.fields.EncryptedCharField', [], {'max_length': '255'}),
