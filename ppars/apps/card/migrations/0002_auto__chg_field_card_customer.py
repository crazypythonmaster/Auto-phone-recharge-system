...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'Card.customer'
        db.alter_column(u'card_card', 'customer_id', self.gf('ppars.apps.core.fields.BigForeignKey')(null=True, to=orm['core.Customer']))

    def backwards(self, orm):

        # Changing field 'Card.customer'
        db.alter_column(u'card_card', 'customer_id', self.gf('ppars.apps.core.fields.BigForeignKey')(default=1, to=orm['core.Customer']))
