...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Card.first_name'
        db.add_column(u'card_card', 'first_name',
                      self.gf('django.db.models.fields.CharField')(default='', max_length=30, blank=True),
                      keep_default=False)

        # Adding field 'Card.last_name'
        db.add_column(u'card_card', 'last_name',
                      self.gf('django.db.models.fields.CharField')(default='', max_length=30, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Card.first_name'
        db.delete_column(u'card_card', 'first_name')

        # Deleting field 'Card.last_name'
        db.delete_column(u'card_card', 'last_name')
    ...
    models = {
        ...
        u'card.card': {
            ...
            'customer': ('ppars.apps.core.fields.BigForeignKey', [], {'related_name': "'cards'", 'null': 'True', 'to': u"orm['core.Customer']"}),
