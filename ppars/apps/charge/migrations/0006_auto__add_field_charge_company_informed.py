...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Charge.company_informed'
        db.add_column(u'charge_charge', 'company_informed',
                      self.gf('django.db.models.fields.BooleanField')(default=False),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Charge.company_informed'
        db.delete_column(u'charge_charge', 'company_informed')
