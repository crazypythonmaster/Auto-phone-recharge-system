...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding model 'ChargeError'
        db.create_table(u'charge_chargeerror', (
        ...
        db.send_create_signal(u'charge', ['ChargeError'])


        # Changing field 'TransactionCharge.created'
        db.alter_column(u'charge_transactioncharge', 'created', self.gf('django.db.models.fields.DateTimeField')(auto_now_add=True))

        # Changing field 'Charge.created'
        db.alter_column(u'charge_charge', 'created', self.gf('django.db.models.fields.DateTimeField')(auto_now_add=True))

    def backwards(self, orm):
        # Deleting model 'ChargeError'
        db.delete_table(u'charge_chargeerror')


        # Changing field 'TransactionCharge.created'
        db.alter_column(u'charge_transactioncharge', 'created', self.gf('django.db.models.fields.DateTimeField')())

        # Changing field 'Charge.created'
        db.alter_column(u'charge_charge', 'created', self.gf('django.db.models.fields.DateTimeField')())
