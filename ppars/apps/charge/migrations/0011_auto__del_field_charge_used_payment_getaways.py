...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Deleting field 'Charge.used_payment_getaways'
        db.delete_column(u'charge_charge', 'used_payment_getaways')


    def backwards(self, orm):
        # Adding field 'Charge.used_payment_getaways'
        db.add_column(u'charge_charge', 'used_payment_getaways',
