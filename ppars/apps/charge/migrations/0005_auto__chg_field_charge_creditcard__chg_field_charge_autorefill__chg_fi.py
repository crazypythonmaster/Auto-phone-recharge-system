...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'Charge.creditcard'
        db.alter_column(u'charge_charge', 'creditcard', self.gf('django.db.models.fields.CharField')(default='', max_length=20))

        # Changing field 'Charge.autorefill'
        db.alter_column(u'charge_charge', 'autorefill_id', self.gf('ppars.apps.core.fields.BigForeignKey')(to=orm['core.AutoRefill'], null=True))

        # Changing field 'Charge.adv_status'
        db.alter_column(u'charge_charge', 'adv_status', self.gf('django.db.models.fields.CharField')(default='', max_length=500))

    def backwards(self, orm):

        # Changing field 'Charge.creditcard'
        db.alter_column(u'charge_charge', 'creditcard', self.gf('django.db.models.fields.CharField')(max_length=20, null=True))

        # User chose to not deal with backwards NULL issues for 'Charge.autorefill'

        # The following code is provided here to aid in writing a correct migration
        # Changing field 'Charge.autorefill'
        db.alter_column(u'charge_charge', 'autorefill_id', self.gf('ppars.apps.core.fields.BigForeignKey')(to=orm['core.AutoRefill']))

        # Changing field 'Charge.adv_status'
        db.alter_column(u'charge_charge', 'adv_status', self.gf('django.db.models.fields.CharField')(max_length=500, null=True))
    ...
    models = {
        ...
        u'charge.charge': {
            ...
            'autorefill': ('ppars.apps.core.fields.BigForeignKey', [], {'to': u"orm['core.AutoRefill']", 'null': 'True'}),
