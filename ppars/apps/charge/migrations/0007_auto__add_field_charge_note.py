...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Charge.note'
        db.add_column(u'charge_charge', 'note',
                      self.gf('django.db.models.fields.TextField')(null=True, blank=''),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Charge.note'
        db.delete_column(u'charge_charge', 'note')
