...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'SpamMessage.carrier'
        db.add_column(u'notification_spammessage', 'carrier',
                      self.gf('ppars.apps.core.fields.BigForeignKey')(to=orm['core.Carrier'], null=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'SpamMessage.carrier'
        db.delete_column(u'notification_spammessage', 'carrier_id')
    ...
    models = {
        ...
        u'notification.spammessage': {
            ...
            'carrier': ('ppars.apps.core.fields.BigForeignKey', [], {'to': u"orm['core.Carrier']", 'null': 'True'}),
