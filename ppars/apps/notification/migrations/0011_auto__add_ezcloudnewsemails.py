...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding model 'EzCloudNewsEmails'
        db.create_table(u'notification_ezcloudnewsemails', (
            (u'id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('emails', self.gf('django.db.models.fields.TextField')(default='', blank=True)),
        ))
        db.send_create_signal(u'notification', ['EzCloudNewsEmails'])


    def backwards(self, orm):
        # Deleting model 'EzCloudNewsEmails'
        db.delete_table(u'notification_ezcloudnewsemails')
