...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding model 'CustomPreChargeMessage'
        db.create_table(u'notification_customprechargemessage', (
            (u'id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('company', self.gf('ppars.apps.core.fields.BigForeignKey')(to=orm['core.CompanyProfile'])),
            ('message', self.gf('django.db.models.fields.TextField')(blank=True)),
            ('use_message', self.gf('django.db.models.fields.BooleanField')(default=False)),
        ))
        db.send_create_signal(u'notification', ['CustomPreChargeMessage'])


    def backwards(self, orm):
        # Deleting model 'CustomPreChargeMessage'
        db.delete_table(u'notification_customprechargemessage')
    ...
    models = {
        ...
        u'core.companyprofile': {
            ...
            'precharge_notification_type': ('django.db.models.fields.CharField', [], {'default': "'SM'", 'max_length': '2'}),
