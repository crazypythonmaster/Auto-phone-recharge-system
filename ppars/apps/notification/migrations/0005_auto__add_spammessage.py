...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.create_table(u'notification_spammessage', (
            ...
            ('customer_type', self.gf('django.db.models.fields.CharField')(default='A', max_length=1)),
            ('created', self.gf('django.db.models.fields.DateTimeField')(auto_now_add=True, blank=True)),
        ))
        db.send_create_signal(u'notification', ['SpamMessage'])


    def backwards(self, orm):
        # Deleting model 'SpamMessage'
        db.delete_table(u'notification_spammessage')
