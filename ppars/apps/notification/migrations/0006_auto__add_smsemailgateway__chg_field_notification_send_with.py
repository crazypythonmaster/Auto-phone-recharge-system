...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding model 'SmsEmailGateway'
        db.create_table(u'notification_smsemailgateway', (
            (u'id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('name', self.gf('django.db.models.fields.CharField')(max_length=50)),
            ('gateway', self.gf('django.db.models.fields.CharField')(max_length=50)),
        ))
        db.send_create_signal(u'notification', ['SmsEmailGateway'])


        # Changing field 'Notification.send_with'
        db.alter_column(u'notification_notification', 'send_with', self.gf('django.db.models.fields.CharField')(max_length=2, null=True))

    def backwards(self, orm):
        # Deleting model 'SmsEmailGateway'
        db.delete_table(u'notification_smsemailgateway')


        # Changing field 'Notification.send_with'
        db.alter_column(u'notification_notification', 'send_with', self.gf('django.db.models.fields.CharField')(max_length=1, null=True))
