...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'SpamMessage.send_with'
        db.add_column(u'notification_spammessage', 'send_with',
                      self.gf('django.db.models.fields.CharField')(default='SM', max_length=2),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'SpamMessage.send_with'
        db.delete_column(u'notification_spammessage', 'send_with')
