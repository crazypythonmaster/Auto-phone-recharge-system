...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'SpamMessage.schedule_type'
        db.add_column(u'notification_spammessage', 'schedule_type',
                      self.gf('django.db.models.fields.CharField')(default='A', max_length=1),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'SpamMessage.schedule_type'
        db.delete_column(u'notification_spammessage', 'schedule_type')
