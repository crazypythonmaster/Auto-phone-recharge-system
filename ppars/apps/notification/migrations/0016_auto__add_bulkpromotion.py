...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding model 'BulkPromotion'
        db.create_table(u'notification_bulkpromotion', (
            (u'id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('body', self.gf('django.db.models.fields.TextField')()),
        ))
        db.send_create_signal(u'notification', ['BulkPromotion'])


    def backwards(self, orm):
        # Deleting model 'BulkPromotion'
        db.delete_table(u'notification_bulkpromotion')
    ...
    models = {
        ...
        u'notification.bulkpromotion': {
            'Meta': {'object_name': 'BulkPromotion'},
        ...
        u'notification.ezcloudnewsemails': {
            'Meta': {'object_name': 'EzCloudNewsEmails'},
        ...
        u'notification.spammessage': {
            ...
            'charge_type': ('django.db.models.fields.CharField', [], {'default': "'A'", 'max_length': '2'}),
            'company': ('ppars.apps.core.fields.BigForeignKey', [], {'to': u"orm['core.CompanyProfile']"}),
            'created': ('django.db.models.fields.DateTimeField', [], {'auto_now_add': 'True', 'blank': 'True'}),
            'customer_type': ('django.db.models.fields.CharField', [], {'default': "'A'", 'max_length': '1'}),
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'message': ('django.db.models.fields.TextField', [], {}),
            'schedule_type': ('django.db.models.fields.CharField', [], {'default': "'A'", 'max_length': '1'}),
            'send_with': ('django.db.models.fields.CharField', [], {'default': "'SE'", 'max_length': '2'})
        },
        u'notification.welcomeemail': {
            'Meta': {'object_name': 'WelcomeEmail'},
            'body': ('django.db.models.fields.TextField', [], {}),
            'category': ('django.db.models.fields.CharField', [], {'max_length': '4', 'null': 'True'}),
            'company': ('ppars.apps.core.fields.BigForeignKey', [], {'to': u"orm['core.CompanyProfile']"}),
