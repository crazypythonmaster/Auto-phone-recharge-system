...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding model 'WelcomeEmail'
        db.create_table(u'notification_welcomeemail', (
            (u'id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('company', self.gf('ppars.apps.core.fields.BigForeignKey')(to=orm['core.CompanyProfile'])),
            ('body', self.gf('django.db.models.fields.TextField')()),
            ('category', self.gf('django.db.models.fields.CharField')(max_length=4, null=True)),
            ('enabled', self.gf('django.db.models.fields.BooleanField')(default=False)),
        ))
        db.send_create_signal(u'notification', ['WelcomeEmail'])


    def backwards(self, orm):
        # Deleting model 'WelcomeEmail'
        db.delete_table(u'notification_welcomeemail')
