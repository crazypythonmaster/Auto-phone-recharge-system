...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Notification.customer'
        db.add_column(u'notification_notification', 'customer',
                      self.gf('ppars.apps.core.fields.BigForeignKey')(default=1, to=orm['core.Customer']),
                      keep_default=False)

        # Adding field 'Notification.phone_number'
        db.add_column(u'notification_notification', 'phone_number',
                      self.gf('django.db.models.fields.CharField')(default=0, max_length=10),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Notification.customer'
        db.delete_column(u'notification_notification', 'customer_id')

        # Deleting field 'Notification.phone_number'
        db.delete_column(u'notification_notification', 'phone_number')
