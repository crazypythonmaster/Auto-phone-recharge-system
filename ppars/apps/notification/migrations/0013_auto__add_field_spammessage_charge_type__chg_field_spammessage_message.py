...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'SpamMessage.charge_type'
        db.add_column(u'notification_spammessage', 'charge_type',
                      self.gf('django.db.models.fields.CharField')(default='A', max_length=2),
                      keep_default=False)


        # Changing field 'SpamMessage.message'
        db.alter_column(u'notification_spammessage', 'message', self.gf('django.db.models.fields.TextField')())

    def backwards(self, orm):
        # Deleting field 'SpamMessage.charge_type'
        db.delete_column(u'notification_spammessage', 'charge_type')


        # Changing field 'SpamMessage.message'
        db.alter_column(u'notification_spammessage', 'message', self.gf('django.db.models.fields.CharField')(max_length=500))
